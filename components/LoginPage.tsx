    ...
    <div className="min-h-screen w-full bg-[#0a0f0d] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans select-none antialiased">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-[#0e1613] border border-[#1b2b23] rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/80 backdrop-blur-md">
          ...
          {/* Form - Only Email and Password as requested */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-3 bg-[#121c17] border border-[#1e2e26] rounded-xl text-xs text-white placeholder-[#455c50] focus:outline-none focus:border-emerald-500/80 focus:ring-1 focus:ring-emerald-500/40 transition-all font-sans"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  className="w-full pl-10 pr-10 py-3 bg-[#121c17] border border-[#1e2e26] rounded-xl text-xs text-white placeholder-[#455c50] focus:outline-none focus:border-emerald-500/80 focus:ring-1 focus:ring-emerald-500/40 transition-all font-sans"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#587365] hover:text-white transition-colors cursor-pointer"
                >
          ...
          <div className="mt-6 pt-4 border-t border-[#182620] text-center text-[11px] text-[#587365]">
            Igreja do Nazareno • Distrito Moçambique Sul
          </div>
